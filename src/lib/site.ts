...
export const SITE = {
  ...
  title: 'Onchain Analytics Review',
  tagline: 'On-chain analytics tools reviewed for traders, researchers, and builders.',
  description:
    'Independent on-chain analytics reviews comparing dashboards, wallet labeling, token metrics, DeFi data, alerts, investigations, APIs, and crypto research workflows.',
  author: {
    name: 'Gelei',
    aboutPath: '/about',
